...
<template>
    <q-page padding class="page-container">
        <div v-if="appStore.activeLog" class="q-mb-xl">
            <div class="row items-center justify-between">
                ...
                <div class="row q-gutter-sm">
                    <q-btn outline color="primary" icon="analytics" label="Insights" rounded
        ...
        <div class="tabs-container q-mb-lg">
            <q-tabs v-model="tab" dense class="text-grey-5" active-color="primary" indicator-color="primary"
        ...
        <div v-if="items != undefined" class="timeline-wrapper">
            <q-timeline color="primary" layout="dense">
                <q-timeline-entry v-for="(item, i) in items" :key="i"
                    ...
                    <template #subtitle>
                        <div class="row justify-between items-center q-mb-sm">
                            <div class="text-caption text-grey-5 row items-center cursor-pointer time-badge">
                            ...
                            <div>
                                <q-btn size="sm" flat dense round color="grey-6" icon="more_vert">
                                    <q-menu auto-close class="smart-border">
                                        <q-list style="min-width: 120px">
                                            <q-item clickable @click="deleteItem(i, item.id)" class="text-negative">
        ...
        <q-page-sticky position="bottom-right" :offset="[24, 24]">
            <q-btn color="primary" icon="add" fab label="New Entry" rounded no-caps padding="sm lg" unelevated
                class="modern-shadow" @click="addNewItem">
        ...
        <q-dialog v-model="showAnalytics" persistent backdrop-filter="blur(4px)">
            <q-card class="glass-card smart-border" style="width: 100%; max-width: 700px;">
